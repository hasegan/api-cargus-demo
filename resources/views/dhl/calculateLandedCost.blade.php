        ...
        <form method="get" action="/landed-cost-calculated"
            ...
            <div class="content">
                <div id="shipperDetalis" class="d-block first">
                    ...
                    <div class="mb-3 shippmentDetails">
                        <div class="d-flex justify-content-center">
                            <label for="senderStateName" class="form-label my-2">State<b>* </b>:</label>
                            <select name="senderStateName" id="senderStateName" class="form-select"
                                onchange="removeWarning(this.id);">
                                <option value="">Select country first</option>
                            </select>
                        </div>
                        <span id="check-senderStateName" class="text-danger"></span>
                    </div>
                    ...
                    <div class="mb-3 shippmentDetails">
                        <div class="d-flex justify-content-center">
                            <label for="senderAddress" class="form-label my-2">Street Name<b>* </b>: </label>
                    ...
                    <div class="mb-3 shippmentDetails">
                        <div class="d-flex justify-content-center">
                            <label for="senderAddressNumber" class="form-label my-2">Number<b>* </b>: </label>
                            <input type="text" class="form-control" id="senderAddressNumber" name="senderAddressNumber"
                                onkeydown="removeWarning(this.id)">
                        </div>
                        <span id="check-senderAddressNumber" class="text-danger"></span>
                    </div>

                    <button type="button" class="btn btn-primary mb-2" id="searchPostalCodeSender">Search for Postal
                        Code</button>

                    <div class="mb-3 shippmentDetails">
                        <div class="d-flex justify-content-center">
                            <label for="senderPostalCode" class="form-label my-2">Postal Code<b>* </b>: </label>
                            <input type="text" class="form-control" id="senderPostalCode" name="senderPostalCode"
                                placeholder="generated by street name" disabled readonly>
                        </div>
                ...
                <div id="receiverDetalis" class="d-none">
                    ...
                    <div class="mb-3 shippmentDetails">
                        <div class="d-flex justify-content-center">
                            <label for="receiverStateName" class="form-label my-2">State<b>* </b>:</label>
                            <select name="receiverStateName" id="receiverStateName" class="form-select"
                                onchange="removeWarning(this.id);">
                                <option value="">Select country first</option>
                            </select>
                        </div>
                        <span id="check-receiverStateName" class="text-danger"></span>
                    </div>
                    ...
                    <button type="button" class="btn btn-primary" id="searchPostalCodeReceiver">Search for Postal
                        Code</button>
                    ...
                    <div class="mb-3 shippmentDetails">
                        <div class="d-flex justify-content-center">
                            ...
                            <input type="text" class="form-control" id="receiverPostalCode" name="receiverPostalCode"
                                disabled readonly placeholder="generated by street name" value="">
                        </div>
